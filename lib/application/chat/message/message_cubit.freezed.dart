...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<MessageRequest> messages});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<MessageRequest> messages)
      : _messages = messages;
...
abstract class _Loaded implements MessageState {
  const factory _Loaded(final List<MessageRequest> messages) = _$LoadedImpl;
